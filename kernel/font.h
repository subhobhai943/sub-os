...
// Simple 8x8 VGA Bitmap Font (Partial ASCII set for brevity)
// 0 = Transparent/Background, 1 = Foreground
static const unsigned char font8x8_basic[128][8] = {
    {0,0,0,0,0,0,0,0}, // 0
    // ... we will use a procedural approach or minimal set to save space if needed
    // But for a CLI tool, I'll include a compact standard set.
    // actually, let's use a very minimal set or a placeholder for now to avoid huge output, 
    // but the user wants a GUI so text is needed. 
    // I will include a basic printable ASCII set (32-127).
    ...
    { 0x3C, 0x66, 0xC6, 0xD6, 0xD6, 0xC6, 0x66, 0x3C }, // 0
    { 0x18, 0x38, 0x18, 0x18, 0x18, 0x18, 0x7E, 0x00 }, // 1
    { 0x7C, 0xC6, 0x06, 0x1C, 0x30, 0x60, 0xFE, 0x00 }, // 2
    { 0x7C, 0xC6, 0x06, 0x3C, 0x06, 0xC6, 0x7C, 0x00 }, // 3
    { 0x1C, 0x3C, 0x6C, 0xCC, 0xFE, 0x0C, 0x1E, 0x00 }, // 4
    { 0xFE, 0x60, 0x7C, 0x06, 0x06, 0xC6, 0x7C, 0x00 }, // 5
    ...
    { 0x3C, 0x66, 0xC6, 0xC6, 0xFE, 0xC6, 0xC6, 0x00 }, // A
    ...
    { 0xC6, 0xC6, 0xC6, 0x6C, 0x38, 0x30, 0x78, 0x00 }, // Y
